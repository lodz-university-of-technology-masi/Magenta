...
INSERT INTO users(username, password, email) VALUES ('redactor', '$2a$10$VRdDEBU.M8FtVpLK7jYlFOQyzcnYx4ktmXehJFvIdej/DIHd0Lciy', 'redactor@example.com');
INSERT INTO users(username, password, email) VALUES ('moderator', '$2a$10$K8YiaFHt8yMA.twuqstwo.fiE.GLlKyG8DbZuxZkMbFtmRP2dufrK', 'moderator@example.com');
